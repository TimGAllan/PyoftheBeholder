...
class DungeonView(object):
    ...
    panels =    ['FP4','KP4','LP4','RP4','FF3','LF3','CF3','RF3','KF3','CD3','LD3','RD3','FP3','LP3','RP3','KP3','LF2','CF2','RF2','CD2','LD2','RD2','LP2','RP2','LF1','CF1','RF1','CD1','LD1','RD1','LP1','RP1']
    tiles={
    ...
    panelsWidthHeights={
        'FP4':( 72,120),'KP4':( 72,120),'LP4':( 16,120),'RP4':( 16,120),'FF3':(144,120),'LF3':(144,120),'CF3':(144,120),'RF3':(144,120),'KF3':(144,120),'CD3':(144,120),'LD3':(144,120),
